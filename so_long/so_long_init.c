...
{
    data->img_wall.path = "IMAGES/wall.xpm";
    ...
    data->img_item.path = "IMAGES/item.xpm";
    ...
    data->img_user.path = "IMAGES/PlayerStart.xpm";
    ...
    data->img_background.path = "IMAGES/leaf.xpm";
    ...
    data->img_exit.path = "IMAGES/exit.xpm";
    ...
    data->img_enemy.path = "IMAGES/enemy.xpm";
